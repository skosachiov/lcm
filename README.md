...
See "Demonstration of secure-boot".
...
## Demonstration of secure-boot role and workstation deploy with preseed.cfg (secure-boot/uki/tpm/cryptsetup, all data on the disk will be lost)

Please note that you will need the UKI kernel generated by the process https://github.com/skosachiov/lcm/actions debian-13-uki

First, check the functionality in the qemu virtual machine. Before installation: 
* Fork the repo, set root and user password hash in `assets/preseed.cfg`
...
`auto=true priority=critical url=https://github.com/<username>/lcm/raw/main/assets/preseed.cfg`
