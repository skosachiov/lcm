...
echo '@reboot root bash -c "sleep 90 && /usr/bin/ansible-pull -i localhost -U https://github.com/skosachiov/lcm.git workstation-crypt-sb-tpm.yml | logger"' >> /etc/cron.d/ansible-pull
